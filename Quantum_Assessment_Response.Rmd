...
The key performance indicator is defined as: $\frac{i_n}{s_n}$ - impressions per dollar. The historical KPIs for each campaign are the coefficients of the objective function. 
